...
function gameLoop() {
  ...
  if (teclaCimaPressionada != teclaBaixoPressionada) {
    // se o jogador estiver pressionando a tecla baixo ou cima
  ...
  if (bolaPosX <= -bolaRaio || bolaPosX > canvas.width) {
    ...
    if (bolaTempo >= 50) {
      ...
      // se o tempo de deixar a bola invisível ainda não passou...
  ...
  // Jogador e Oponente
  //
  // context.fillRect(jogadorPosX, jogadorPosY, barraWidth, barraHeight) //jogador controlado pelo teclado
  //

  context.drawImage(ramony, jogadorPosX - 15, oponentePosY - 10)
  context.drawImage(phaulos, oponentePosX - 35, oponentePosY - 10)

  //context.fillRect(jogadorPosX, oponentePosY, barraWidth, barraHeight) //desenha jogador (ramony)
  //context.fillRect(oponentePosX, oponentePosY, barraWidth, barraHeight) //desenha oponente (phaulos)
  ...
  */
  ...
  context.fillText('ticket', bolaPosX - 25, bolaPosY + 6)
  ...
  if (pontosA < 10) {
    // se o número de pontos for menor que 10, colocamos o zero á esquerda
    pontosA = '0' + pontosA
  }
  if (pontosB < 10) {
    // se o número de pontos for menor que 10, colocamos o zero á esquerda
